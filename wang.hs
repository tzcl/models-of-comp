...
wang
  :: [Exp]   -- Left-hand side of (unreduced) sequent
...
-- Implement recursive cases for biimplication here!
...
wang [] [] reducedLeft reducedRight =
  or [ x == y | x <- reducedLeft, y <- reducedRight ]
